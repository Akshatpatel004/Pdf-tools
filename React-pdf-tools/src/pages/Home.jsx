              ...
              <section key={categoryName} className="mb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-500">
                  {categoryTools.map((tool, idx) => (
                    <div key={idx} onClick={() => navigate(`/tool/${tool.route}`)} className="flex flex-col gap-4 rounded-2xl border border-primary/10 bg-white dark:bg-slate-900 p-6 transition-all cursor-pointer border-b-4 border-b-primary/10 hover:border-b-red-500 hover:-translate-y-1 hover:shadow-md">
