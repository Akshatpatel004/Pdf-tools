...
    };
    
    // Check for GAPI availability and init
...
      const isAllowed = file.type === tool.mineType || file.type === allowedType || isPdf;
...
                {/* Cloud Upload Buttons - Preference: items-start, gap-4, p-4 */}
